    ...
    <div className="fixed top-4 right-4 z-40 space-y-2">
      ...
      {gameState === 'guessing' && (
        <button
          onClick={onUseHint}
          disabled={!canUseHint}
          className={`w-full px-4 py-3 border-2 border-black font-bold uppercase tracking-wider text-sm flex items-center gap-2 shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:shadow-[1px_1px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[1px] hover:translate-y-[1px] transition-all duration-100 ${
            canUseHint 
